...
addCard = function(electorate_name) {
	var x =0;
...
Raphael.fn.makeMap = function (xMap,yMap, x, y, width, height){
    ...
    reset.mouseover(function() {
    	...
    	boxtext = canvasMap.flag(270, 595, "Reset");
	 });
    ...
    labour.mouseover(function() {
    	boxtext = canvasMap.flag(270, 535, "Labour");
	 });

    labour.mouseout(function() {
    	boxtext.remove();
    });

    liberal.mouseover(function() {

    	boxtext = canvasMap.flag(270, 565, "Liberal");
	 });

    liberal.mouseout(function() {
    	boxtext.remove();
    });
